...
public class netherStarHeart extends Item{
	...
	public netherStarHeart(){
		setTextureName(heartControl.modID + ":netherStarHeart"); 
		setUnlocalizedName("hc.netherStarHeart");
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
	{
		...
		if(!world.isRemote)
		{
			hcLogger.logger(player + "used a Nether Heart");
